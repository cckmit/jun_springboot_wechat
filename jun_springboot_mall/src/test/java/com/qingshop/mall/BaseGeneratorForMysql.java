...
public class BaseGeneratorForMysql {
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://127.0.0.1:3306/adminlte-mall?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
